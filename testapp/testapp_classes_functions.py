...
import sys
from testapp.physics_dev import dev_questions_logic
...
class Question():
    ...
    questionNumber, questionBase, codeBase, answerBase, answerCodeBase, answerUnits, marksBase = 1, None, None, None, None, None, None

    #variables for parts of a question for use with main question
    questionPartList = None # this list needs to dicts including items subNumber, subQuestion, subQuestionCode, subAnswer, subAnswerCode, subUnits, subMarks]
    ...
    def returnAll(self):
        ...
        'questionPartList': self.questionPartList,# this list needs to dicts including items subNumber, subQuestion, subQuestionCode, subAnswer, subAnswerCode, subUnits, subMarks]
...
def previousNext(modList, qtype = None, start = 0, end = None, name='', module_path=''):#uses list of all functions to return previous and next modules in list
