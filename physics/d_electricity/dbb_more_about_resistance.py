...
def dba1_two_components_parallelpxax6():
    ...
    q.questionBase = f"The battery in the circuit above has an emf of {batPd}v and negligible internal resistance. It is connected to a {comp1Pd}v, {comp1P}W {thing} (a) in parallel with another {comp2Pd}v, {comp2P}W {thing} (b). Calculate:"
