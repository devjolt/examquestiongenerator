...
import sys
from alevelmaths.e_trigonometry import e4_co_arc_logic
...
class Question():
    ...
    questionNumber, questionBase, questionCodeBase, answerBase, answerCodeBase, marksBase = 1, None, None, None, None, None
    ...
    def returnAll(self):
        ...
        'questionNumber':self.questionNumber, 'questionBase': self.questionBase, 'questionCodeBase': self.questionCodeBase, 'answerBase': self.answerBase, 'answerCodeBase': self.answerCodeBase, 'marksBase': self.marksBase,
