...
def algebra_basics_random():
    modList = moduleListGen("basics", 0, 6)
    selection = randint(0,len(modList)-1)
    passed = eval(f"{modList[selection]}()")
    return passed

def algebra_brackets_random():
    modList = moduleListGen("expand", 0, 6)
    selection = randint(0,len(modList)-1)
    passed = eval(f"{modList[selection]}()")
    return passed

def algebra_powers_random():
    modList = moduleListGen("power", 0, 5)
    selection = randint(0,len(modList)-1)
    passed = eval(f"{modList[selection]}()")
    return passed

def algebra_surds_random():
    modList = moduleListGen("surd", 0, 4)
    selection = randint(0,len(modList)-1)
    passed = eval(f"{modList[selection]}()")
    return passed

def algebra_solve_random():
    modList = moduleListGen("solve", 0, 5)
    selection = randint(0,len(modList)-1)
    passed = eval(f"{modList[selection]}()")
    return passed

def algebra_factorising_random():
    modList = moduleListGen("factorising", 0, 11)
    selection = randint(0,len(modList)-1)
    passed = eval(f"{modList[selection]}()")
    return passed

def basics_negative_numbers():
...
def basics_multiplying_letters():
...
def basics_collecting_like_terms():
...
def expand_brackets_three_letters():
    letter1, letter2, letter3 = letterGen(), letterGen(), letterGen()
    ops = ["-", "+"]
    ...
    previousQ, nextQ = previousNext("expand", 0, 6, currentFuncName())
    diagram, constant = None, None
    marks, level = 1, 3
    pre, preans = None, None
    tip = None
...
def expand_brackets_numbers_letters():
...
def power_of_zero():
    ...
    answer = 1
    previousQ, nextQ = previousNext("power", 0, 5, currentFuncName())
    diagram, constant = None, None
    marks, level = 1, 5
    pre, preans = None, None
    tip = None
...
def power_raising_two_powers_to():
    letterNumber = randint(0,1)
    if letterNumber == 0: value = letterGen()
    else: value = randint(1, 99)
...
def power_with_fractions_letters():
...
def factorising_two_letters():
    ...
    previousQ, nextQ = previousNext("factorising", 0, 11, currentFuncName())
    diagram, constant = None, None
    marks, level = 2, 5
    pre, preans = None, None
    tip = None
...
def solve_divide():
    ...
    previousQ, nextQ = previousNext("solve", 0, 5, currentFuncName())
    diagram, constant = None, None
    marks, level = 2, 5
    pre, preans = None, None
    tip = None
...
def solve_collectx_collectint_divide():
    x = randint(2,12)
    answer = (f"x = {x}")
    newx = randint(2, 5)
    newint = newx * x
...
def solve_collectx_collectint_divide_brackets():
    x = randint(2,6)
    answer = (f"x = {x}")
    print(answer)
    newx = randint(2, 5)
...
def solve_collectx_collectint_divide_brackets_double():
    x = randint(2,12)
    answer = (f"x = {x}")
    print(answer)
    newx = randint(2, 5)
...
def solve_posneg_collectx_collectint_divide_brackets():
    x = 0
    while x == 0:
        x = randint(-12, 12)
    xmultnum, addx = 0, 0
...
def solve_posneg_collectx_collectint_divide_brackets_fractions():
    x = 0
    while x == 0:
        x = randint(-12, 12)
    xmultnum, addx = 0, 0
...
def solve_posneg_collectx_collectint_divide_brackets_first_fraction():
    x = 0
    while x == 0:
        x = randint(-12, 12)
    xmultnum, addx = 0, 0
    ...
    if x > 0:
        ...
        '''
    questionBase = "Solve to find x"
    diagram, constant, marks = None, None, 3
    previousQ, nextQ = previousNext("solve", 0, 5, currentFuncName())
    level = 3
    preans = None
    tip = None
    video, website = None, None
    return (previousQ, nextQ, diagram, constant, questionBase, answer, pre, None, marks, level, tip, video, website)

def solve_posneg_collectx_collectint_divide_brackets_second_fraction():
    x = 0
    while x == 0:
        x = randint(-12, 12)
    xmultnum, addx = 0, 0
